...
function sendData() {
	...
	urlEncodedDataPairs.push(
		encodeURIComponent("requested-date") +
			"=" +
			encodeURIComponent(form.querySelector("[name='requested-date']").value)
	);
	urlEncodedDataPairs.push(
		encodeURIComponent("people-count") + "=" + encodeURIComponent(form.querySelector("[name='people-count']").value)
	);
	...
	// dropdown menu
	var dropdown = form.querySelector("[name='abduction-experience']");
	urlEncodedDataPairs.push(
		encodeURIComponent("abduction-experience") +
			"=" +
